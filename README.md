...
Install the numpy and pylatex Python libraries before cloning or downloading this repository.
The script requires [Latex](https://www.latex-project.org/get/) to be installed on your system.
...
## Usage
To start the program, run the __main__.py file or the entire project folder directly:
